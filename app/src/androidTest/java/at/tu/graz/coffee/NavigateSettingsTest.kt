...
class NavigateSettingsTest {
    ...
    fun navigateSettingsTest() {
        ...
        val materialRadioButton = onView(
            allOf(
                withId(R.id.language_first_radio), withText("First language"),
                childAtPosition(
                    childAtPosition(
        ...
        val materialRadioButton2 = onView(
            allOf(
                withId(R.id.language_second_radio), withText("Second language"),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("androidx.constraintlayout.widget.ConstraintLayout")),
                        0
